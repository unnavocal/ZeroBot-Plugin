...
import (
	...
	_ "github.com/Yuri-YuzuChaN/maimaiDX" // mai
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "爱拉", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "AL", "爱拉"，"arr","arbot",),
